 ...
 *       &lt;choice&gt;
 *         &lt;group ref="{urn://x-artefacts-cfa/cfa-projects-additional-contributions-commons/1.0.0}processingStatus-ModelGroup"/&gt;
 *         &lt;group ref="{urn://x-artefacts-cfa/cfa-projects-additional-contributions-commons/1.0.0}rejectStatusDetail-ModelGroup" maxOccurs="unbounded"/&gt;
 *       &lt;/choice&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ResponseInfoType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "individualDepositorSNILS", namespace = "urn://x-artefacts-cfa/cfa-projects-additional-contributions-commons/1.0.0", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "rejectionReason", namespace = "urn://x-artefacts-cfa/cfa-projects-additional-contributions-commons/1.0.0", type = JAXBElement.class, required = false)
    })
    @Generated(value = "com.sun.tools.xjc.Driver", comments = "JAXB RI v3.0.2", date = "2024-04-09T12:49:50+03:00")
